            ...
            <div className="flex gap-3">
                <div className="flex flex-col flex-1">
                    ...
                    <input
                        ...
                        min={0}
                        max={duration}
                        value={isEditing ? localStart : start.toFixed(Constants.ANNOTATION_DEFAULT_TIME_INTERVAL_PRECISION)}
                        onFocus={beginEdit}
                ...
                <div className="flex flex-col flex-1">
                    ...
                    <input
                        ...
                        min={0}
                        max={duration}
                        value={isEditing ? localEnd : end.toFixed(Constants.ANNOTATION_DEFAULT_TIME_INTERVAL_PRECISION)}
                        onFocus={beginEdit}
