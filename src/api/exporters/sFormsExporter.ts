...
const NS = {
  ...
  strokeColor: 'http://onto.fel.cvut.cz/ontologies/form/media/annotation/has-color',
  strokeWidth: 'http://onto.fel.cvut.cz/ontologies/form/media/annotation/has-stroke-width',
  hasOpacity: 'http://onto.fel.cvut.cz/ontologies/form/media/annotation/has-opacity',
